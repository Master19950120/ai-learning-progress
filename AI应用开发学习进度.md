...
1. **LLM API 开发**：Chat API、流式输出、Structured Output、Tool Calling。
...
| 2026-08-20 | 4 | API Key 与安全管理 | 使用环境变量注入密钥；真实 `.env`、源码和日志不得提交或暴露。 | 已完成 |
...
## 下一课建议：Chat API（30–40 分钟）

1. 理解 Chat API 的请求与响应结构。
2. 用 Java 组装 system、user、assistant 消息。
3. 处理超时、错误响应和基础重试。
